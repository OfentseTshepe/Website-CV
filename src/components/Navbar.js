...
function Navbar(){
    ...
    return(
        ...
        <Box sx={{ flexGrow: "1" }}>
            <HashLink  to={"#Home"}  smooth={1000} style={{color:"white",marginRight:"20px",textDecoration:"none"}}>
              <Button sx={{ color :"white","&:hover":{color:"#FE805D",backgroundColor:"transparent"}}}>  <h2>Home</h2></Button>
            </HashLink>
        </Box>
